...
const Register = () => {
	...
	<form noValidate="" action="" className="space-y-8">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-gradient-to-r from-blue-500 via-cyan-400 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-700  text-white dark:bg-violet-600 dark:text-gray-50">register</button>
	</form>
            </div>
        </div>
    );
