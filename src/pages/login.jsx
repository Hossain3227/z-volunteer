...
const handleLogIn = async e => {
    ...
    return (
        <div className="flex md:flex-row flex-col  gap-4 my-12">
            <div className="">
                <img src="https://i.ibb.co/4mXQpvj/image-processing20210909-13702-17te8mg.gif" alt="" />
            </div>
	...
	<p className="text-sm text-center dark:text-gray-600">Dont have account?
        ...
        <Link to={'/register'}  className="focus:underline hover:underline text-blue-400 ml-2">Register here</Link>
	</p>
	...
	<form onSubmit={handleLogIn} noValidate="" action="" className="space-y-8">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-blue-500 text-white dark:bg-violet-600 dark:text-gray-50">log in</button>
	</form>
            </div>
        </div>
    );
